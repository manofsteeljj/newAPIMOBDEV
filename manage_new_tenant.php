...
try {
    $stmt = $pdo->query("SELECT * FROM tenants WHERE room_id IS NULL");
    ...
    <div class="content">
        ...
        <div class="table-container">
            <div class="table-controls">
                <button onclick="window.location.href='add_new_tenant.php'" class="add-button">Add New Tenant</button>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button class="manage_btn" onclick="window.location.href='assign_tenant.php?id=<?= $tenant['id'] ?>'">Assign</button>
                                <button class="edit_btn" onclick="window.location.href='edit_tenant.php?id=<?= $tenant['id'] ?>'">Edit</button>
                                <button class="delete_btn" onclick="deleteTenant(<?= $tenant['id'] ?>)">Delete</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
